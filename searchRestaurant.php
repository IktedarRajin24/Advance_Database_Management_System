...
<body>
    <div class="container">
        ...
        <form action="searchRestaurant.php" method="POST">
            ...
            <input type="text" name="restaurantName" id="restaurantName" placeholder="Restaurant Name" oninput="showRestaurant(this.value)">
    ...
    function showRestaurant(str) {
        ...
        xmlhttp.open("GET", "SearchRestaurantView.php?restaurantName=" + str, true);
        xmlhttp.send();
    }
    </script>
